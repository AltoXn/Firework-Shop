...
public class Fireworks extends PluginWrapper {
	...
	public static void Usage(CommandSender sender, String cmd){
		sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&cIncorrect command parameters."));
		sender.sendMessage(ChatColor.translateAlternateColorCodes('&', "&cUsage: " + cmd));
	}
}
